...
aba_toolkit <- function() {
  tibble::tribble(
    ...
    "Withholding the maintaining reinforcer reduces the response; resistance to extinction is greatest under continuous reinforcement and declines on leaner schedules.",
    "Oxford (Basic Principles); Fisher Ch 19. A necessary component of differential-reinforcement treatments.",
    "Reproduces the contingency, not a clinical extinction procedure. The ordering is the reverse of the partial-reinforcement extinction effect: this value-tracking agent builds the highest action value under continuous reinforcement and so is slowest to extinguish, and does not reproduce PREE, whose generalisation-decrement mechanism it lacks.",
